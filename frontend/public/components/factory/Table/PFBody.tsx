...
import {
  ...
  Scroll,
} from '@patternfly/react-virtualized-extension/dist/js/components/Virtualized/types';

import accessibilityOverscanIndicesGetter from '@patternfly/react-virtualized-extension/dist/js/components/Virtualized/accessibilityOverscanIndicesGetter';
import {
  VirtualGrid,
  VirtualGridProps,
} from '@patternfly/react-virtualized-extension/dist/js/components/Virtualized/VirtualGrid';
...
export class VirtualTableBody extends React.Component<VirtualTableBodyProps> {
  ...
  _cellRenderer = ({
    ...
    const { rowRenderer, rows, columns } = this.props;
