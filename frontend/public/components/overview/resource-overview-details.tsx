...
export const ResourceOverviewDetails = connect<PropsFromState, PropsFromDispatch, OwnProps>(
  ...
  ({
    ...
    const overviewResourceTabs = useExtensions<OverviewResourceTab>(isOverviewResourceTab);
    ...
    if (
      ...
      pluginTabsRef.current = getPluginTabResources(item, tabs, overviewResourceTabs);
    }
    return (
