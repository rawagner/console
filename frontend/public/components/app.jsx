            ...
            <div id="content">
              ...
              <div id="content-scrollable">
                <Switch>
                  ...
                  <LazyRoute path="/dashboards" loader={() => import('../kubevirt/components/dashboards/dashboards' /* webpackChunkName: "kubevirt-cluster-overview" */).then(m => m.DashboardsConnected)} />
