...
import { getAlertSeverity, getAlertMessage, getAlertDescription, getAlertTime } from '../health-card';
...
export const StatusItem: React.FC<StatusItemProps> = ({ Icon, timestamp, message, LinkComponent }) => {
  return (
    <div className="co-status-card__alert-item">
      <div className="co-dashboard-icon"><Icon /></div>
