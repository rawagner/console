...
import { ContainerStatus, PodKind, ContainerSpec } from '@console/internal/module/k8s/types';
import { LoadingInline } from '@console/internal/components/utils/status-box';
import { errorModal } from '@console/internal/components/modals/error-modal';
import { useScrollDirection, ScrollDirection } from '@console/shared/src/hooks/scroll';
import { useFullscreen } from '@console/shared/src/hooks/fullscreen';
