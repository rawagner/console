...
export const CreateVM: React.FC<RouteComponentProps> = ({ location }) => {
  ...
  const dataSource = bootState.dataSource?.value;
      ...
      getVMWizardCreateLink({
        ...
        bootSource: dataSource
          ? {
              ...
              url: dataSource === DataSource.URL ? bootState.url?.value : undefined,
              container:
                dataSource === DataSource.REGISTRY ? bootState.container?.value : undefined,
              pvcName: dataSource === DataSource.CLONE ? bootState.pvcName?.value : undefined,
              pvcNamespace:
                dataSource === DataSource.CLONE ? bootState.pvcNamespace?.value : undefined,
            }
          : undefined,
      }),
    );
