...
func (p *Proxy) ServeGQLHTTP(w http.ResponseWriter, r *http.Request) {
	...
	log.Printf("GQL URL %s", r.URL)
	log.Printf("GQL Websocket %s", isWebsocket)
	...
	log.Printf("GQL Websocket HOST %s", r.Host)
	log.Printf("GQL Websocket URL HOST %s", r.URL.Host)
	log.Printf("GQL Websocket Scheme %s", r.URL.Scheme)
	log.Printf("GQL Websocket PATH %s", r.URL.Path)
	log.Printf("GQL Websocket FINAL URL %s", r.URL.String())
	...
	log.Printf("GQL Headers %s", proxiedHeader)
